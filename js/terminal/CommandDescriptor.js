var CommandDescriptor = function(){
  ...
  this.syncAnimations.types.push(this.OBJECT_TEXT_SPRITE_CONTAINER_NAME); //sourceName
  this.syncAnimations.types.push(this.OBJECT_TEXT_SPRITE_CONTAINER_NAME); //targetName
