var Text = function(){
  ...
  this.ANIMATION_GROUP_CREATED = "Animation group created.";
  this.ANIMATION_GROUP_REMOVED = "Animation group removed.";
  ...
  this.SHAPES = "Shapes";
  this.SHADOW_QUALITY_UPDATED = "Shadow quality updated.";
  ...
  this.BAKING_SHADOW_FOR = "   |____Baking shadow for [@@1] - [@@2]";
  this.TYPE_NOT_SUPPORTED = "      |____Type not supported";
  this.SHADOW_BAKE_DONE = "      |____Done in @@1 ms"
  ...
  this.ANTIALIAS_ENABLED = "Antialias enabled. Note that antialias changes are applied only in builds.";
  this.ANTIALIAS_DISABLED = "Antialias disabled. Note that antialias changes are applied only in builds.";
  ...
  this.NO_OBJECT_OR_TEXT_ADDED_TO_THE_SCNENE = "No objects or 3D texts added to scene.";
  ...
  this.MASS_SELECTED = "Mass selected.";
  ...
  this.ERROR_HAPPENED_GENERATING_TEXTURE_ATLAS = "Error happened generating texture atlas.";
  this.ERROR_HAPPENED_REFRESINH_SHADOW_MAPS = "Error happened refreshing shadow maps.";
  ...
  this.PHYSICS_WORKER_TURNED_OFF = "Physics worker turned off.";
  this.LIGHTNING_WORKER_TURNED_ON = "Lightning worker turned on.";
  this.LIGHTNING_WORKER_TURNED_OFF = "Lightning worker turned off.";
  ...
  this.MODEL_INSTANCE_HAS_METALNESS_MAP_GOURAUD_MODE_SPECULARITY = "Model instance has metalness map. Cannot enable specularity in Gouraud lighting mode.";
  ...
  this.NO_OBJECT_FOUND_WITH_SHADOWS = "No objects found with shadows.";
  ...
  this.A_LIGHT_IS_NECESSARY_TO_BAKE_SHADOW = "A light is necessary to bake shadow.";
  ...
  this.INSTANCING_DISABLED = "Instancing disabled.";
  ...
  this.OBJECT_DOES_NOT_HAVE_BAKED_SHADOW = "Object does not have baked shadow.";
  ...
  this.KNOWLEDGE_USED_IN_STATE_MACHINE_CANNOT_DESTROY = "Knowledge used in state machine [@@1]. Cannot destroy.";
  this.KNOWLEDGE_USED_IN_DECISION_TREE_CANNOT_DESTROY = "Knowledge used in decision tree [@@1]. Cannot destroy."
  ...
  this.DECISION_TREE_HAS_A_CLONE_CANNOT_DESTROY = "Decision tree has a clone [@@1]. Cannot destroy.";
  ...
  this.VALUES_MUST_BE_BETWEEN_0_1 = "Values must be between 0 and 1.";
  this.SPECULAR_COLOR_SET = "Specular color set.";
  this.LOADING_MODULES = "Loading modules.";
  this.NO_MODULES_UNDER_MODULES_FOLDER = "No modules under modules folder.";
  this.ADDING_MODULE = "Adding module.";
  this.USE_GUI_TO_ADD_REMOVE_MODULES = "Use GUI to add/remove modules.";
  this.MODULE_ADDED = "Module added.";
  this.MODULE_REMOVED = "Module removed.";
  ...
  this.CANNOT_ADD_ANIMATION_TO_MODEL_INSTANCES_WITH_MASS = "Model instance has mass. Cannot add animation.";
  ...
  this.DECISION_ALREADY_HAS_A_YES_NODE = "Decision already has a yes node.";
  this.DECISION_ALREADY_HAS_A_NO_NODE = "Decision already has a no node.";
  ...
  this.OBJECT_TYPE_NOT_SUPPORTED_FOR_SHADOW_BAKING = "Object type not supported for shadow baking: [@@1].";
  this.CHILD_OBJECT_TYPE_NOT_SUPPORTED_FOR_SHADOW_BAKING = "Child object type not supported for shadow baking.";
  this.BAKING_SHADOW = "|____Baking shadow.";
  ...
  this.MODEL_INSTANCE_DOES_NOT_HAVE_ENV_MAP = "Model instance does not have an environment map.";
  this.ENVIRONMENT_MAP_UPDATED = "Environment map updated.";
  this.SKYBOX_NAME_CANNOT_BE_EMPTY = "Skybox name cannot be empty.";
  this.ENVIRONMENT_MAP_CREATED = "Environment map created.";
  this.ENVIRONMENT_MAP_REMOVED = "Environment map removed.";
  ...
  this.ROOT_DECISION_UNSET = "Root decision unset.";
  this.YES_NODE_UNSET = "Yes node unset.";
  this.NO_NODE_UNSET = "No node unset.";
  this.DECISION_DOES_NOT_HAVE_A_YES_NODE_SET = "Decision does not have a yes node set.";
  this.DECISION_DOES_NOT_HAVE_A_NO_NODE_SET = "Decision does not have a no node set.";
  this.CANNOT_VISUALISE_DECISION_TREE_WO_ROOT_DECISION = "Cannot visualise decision tree without a root decision.";
  ...
  this.SHOWING_SETTINGS = "Showing settings.";
  this.SETTINGS_GUI_CLOSED = "Settings GUI closed.";
  ...
  this.LIGHT_BAKING_MUST_BE_PERFORMED_ON_COPY_PARENT = "Light baking must be performed on soft copy parent [@@1].";
  this.LIGHT_UNBAKING_MUST_BE_PERFORMED_ON_COPY_PARENT = "Light unbaking must be performed on soft copy parent [@@1]."
  ...
  this.USE_GUI_TO_CREATE_STEERING_BEHAVIORS = "Use the GUI to create/edit steering behaviors.";
  ...
  this.USE_GUI_TO_CREATE_STATE = "Use the GUI to create state.";
  this.USE_GUI_TO_CREATE_TRANSITION = "Use the GUI to create transition.";
  this.USE_GUI_TO_CREATE_DECISION_TREE = "Use the GUI to create/edit decision tree.";
  this.USE_GUI_TO_CREATE_STATE_MACHINE = "Use the GUI to create/edit state machine.";
  this.EDGE_ALREADY_EXISTS = "Edge already exists.";
  this.OBJECT_HAS_BAKED_LIGHTS_CANNOT_MARK_AS_CHANGEABLE = "Object has baked lights. Cannot mark as changeable.";
  this.OBJECT_HAS_BAKED_SHADOW_CANNOT_MARK_AS_CHANGEABLE = "Object has baked shadow. Cannot mark as changeable.";
  ...
  this.OBJECT_HIDDEN = "Object hidden.";
  this.OBJECT_SHOWN = "Object shown.";
  this.SPRITE_HIDDEN = "Sprite hidden.";
  this.SPRITE_SHOWN = "Sprite shown.";
  this.TEXT_HIDDEN = "Text hidden.";
  this.TEXT_SHOWN = "Text shown.";
  this.BLOOM_IS_MARKED_AS_SELECTIVE = "Bloom is marked as selective";
  this.BLOOM_IS_MARKED_AS_NON_SELECTIVE = "Bloom is marked as non selective";
  this.BLOOM_IS_NOT_ACTIVE_CANNOT_MAKE_SELECTIVE = "Bloom needs to be active in order to be marked as selective.";
  this.CONTAINER_HIDDEN = "Container hidden.";
  this.CONTAINER_SHOWN = "Container shown.";
  this.VIRTUAL_KEYBOARD_HIDDEN = "Virtual keyboard hidden.";
  this.VIRTUAL_KEYBOARD_SHOWN = "Virtual keyboard shown.";
  ...
  this.AFFECTED_BY_SELECTIVE_BLOOM = "Object will be affected by selective bloom if the bloom is marked as selective.";
  this.NOT_AFFECTED_BY_SELECTIVE_BLOOM = "Object will not be affected by selective bloom if the bloom is marked as selective.";
  ...
  this.CHANGEABLE_OBJECTS_DO_NOT_SUPPORT_THIS_COMMAND = "Changeable objects do not support this command.";
  this.DYNAMIC_OBJECTS_DO_NOT_SUPPORT_THIS_COMMAND = "Dynamic objects do not support this command.";
  this.NO_STATIC_LIGHTS_IN_SCENE = "No static lights in the active scene.";
  this.LIGHTS_BAKED = "Lights baked.";
  this.LIGHTS_UNBAKED = "Lights unbaked.";
  this.OBJECT_IS_NOT_MARKED_AS_AFFECTED_BY_LIGHT = "Object is not marked as affected by light.";
  ...
  this.MODEL_INSTSANCE_NOT_COMPRESSABLE = "Model instance not compressable.";
  this.MODEL_INSTANCE_COMPRESSED = "Model instance compressed.";
  this.MODEL_HAS_COMPRESSED_MODEL_INSTANCE = "Model has a compressed model instance. Cannot create a new instance.";
  this.MODEL_HAS_COMPRESSED_MODEL_INSTANCE_TEXTURE_REFRESH = "Model [@@1] has a compressed instance. Won't refresh UVs.";
  ...
  this.MASS_NOT_IN_ACTIVE_SCENE = "Mass not in active scene.";
  ...
  this.INVALID_FALLBACK_DIFFUSE_VECTOR = "Invalid fallback diffuse vector.";
  this.FALLBACK_DIFFUSE_VECTOR_SET = "Fallback diffuse vector set. This is used in devices that do not support GL_EXT_shader_texture_lod.";
  ...
  this.DEV_SERVER_WS_URL_SET = "Development server WS URL set.";
  ...
  this.DEV_SERVER_WS_URL_RESET = "Development server WS URL reset.";
  ...
  this.KNOWLEDGE_IS_REQUIRED_TO_CREATE_A_DECISION_TREE = "A knowledge is required to create a decision tree";
  this.KNOWLEDGE_IS_REQUIRED_TO_CREATE_A_STATE_MACHINE = "A knowledge is required to create a state machine.";
  this.ENTRY_STATE_IS_REQUIRED_TO_CREATE_A_STATE_MACHINE = "An entry state is required to create a state machine.";
  this.DECISION_NAME_CANNOT_BE_EMPTY = "Decision name cannot be empty.";
  this.STATE_NAME_CANNOT_BE_EMPTY = "State name cannot be empty.";
  this.TRANSITION_NAME_CANNOT_BE_EMPTY = "Transition name cannot be empty.";
  this.DECISION_TREE_NAME_CANNOT_BE_EMPTY = "Decision tree name cannot be empty.";
  this.SOURCE_STATE_NAME_CANNOT_BE_EMPTY = "Source state name cannot be empty.";
  this.TARGET_STATE_NAME_CANNOT_BE_EMPTY = "Target state name cannot be empty.";
  this.STATE_MACHINE_NAME_CANNOT_BE_EMPTY = "State machine name cannot be empty.";
  this.SOURCE_STATE_AND_TARGET_STATE_CANNOT_BE_THE_SAME = "Source state and target state cannot be the same.";
  this.ENTRY_STATE_HAS_ANOTHER_PARENT = "Entry state has another parent: [@@1].";
  this.NODE_VALUE_CANNOT_BE_EMPTY = "Node value cannot be empty.";
  this.YES_NODE_SET = "Yes node set.";
  this.NO_NODE_SET = "No node set.";
  this.STATE_ADDED = "State added.";
  this.STATE_REMOVED_FROM_SM = "State removed from state machine.";
  this.CANNOT_REMOVE_ENTRY_STATE = "Cannot remove the entry state.";
  this.TRANSITION_EXISTS_WITH_SOURCE_STATE = "Transition [@@1] depends on this state. Cannot remove from state machine.";
  this.STATE_HAS_ANOTHER_PARENT = "State already has another parent.";
  this.STATE_MACHINE_ALREADY_HAS_THIS_STATE = "State machine already has this state.";
  this.STATE_IS_ENTRY_STATE_CANNOT_DESTROY = "State is used as entry state in state machine [@@1]. Cannot destroy.";
  this.STATE_MACHINE_IS_ENTRY_STATE_CANNOT_DESTROY = "State machine is used as entry state in state machine [@@1]. Cannot destroy.";
  this.STATE_MACHINE_CREATED = "State machine created.";
  this.STATE_MACHINE_CLONED = "State machine cloned.";
  this.KNOWLEDGE_HAS_NO_INFORMATION = "Knowledge has no informaton inside.";
  this.DECISION_NAME_MUST_BE_UNIQUE = "Decision name must be unique.";
  this.DECISION_TREE_NAME_MUST_BE_UNIQUE = "Decision tree name must be unique.";
  this.DECISION_CREATED = "Decision created.";
  this.STATE_CREATED = "State created.";
  this.STATE_DESTROYED = "State destroyed.";
  this.DECISION_DESTROYED = "Decision destroyed.";
  ...
  this.NOT_VISUALISING = "Not visualising @@1.";
  this.INVALID_RANGE = "Invalid range. Range must be in [lowerBound,upperBound] format. For exclusive bounds use ] instead of [.";
  ...
  this.CANNOT_ADD_ANIMATIONS_TO_INTERSECTABLE_MODEL_INSTANCES = "Cannot add animations to intersectable model instances.";
  this.MODEL_INSTANCE_HAS_ANIMATIONS_CANNOT_MARK_AS_INTERSECTABLE = "Model instance has animations. Cannot mark as intersectable.";
  this.MODEL_INSTANCE_HAS_ANIMATIONS_CANNOT_SET_MASS = "Model instance has animations. Cannot set mass.";
  this.NO_SUCH_MODEL_INSTANCE = "No such model instance.";
  this.STATE_MACHINE_DESTROYED = "State machine destroyed.";
  this.SOURCE_MODEL_INSTANCE_NOT_FOUND = "Source model instance not found.";
  this.TARGET_MODEL_INSTANCE_NOT_FOUND = "Target model instance not found.";
  this.SOURCE_MODEL_INSTANCE_NOT_IN_ACTIVE_SCENE = "Source model instance not in active scene.";
  this.TARGET_MODEL_INSTANCE_NOT_IN_ACTIVE_SCENE = "Target model instance not in active scene.";
  this.ORIENTATION_SYNCED = "Orientation synced.";
  ...
  this.PBR_DISABLED_FOR_MODEL_INSTANCE = "PBR disabled for model instance.";
  this.PBR_ENABLED_FOR_MODEL_INSTANCE = "PBR enabled for model instance. Note that diffuse, ambient and dynamic lights are not supported for such materials.\nModifying light intensity would have no effect as well.";
  this.LIGHT_ATTENUATION_COEFFICIENT_SET = "Light attenuation coefficient set.";
